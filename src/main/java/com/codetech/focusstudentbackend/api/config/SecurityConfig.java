...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "https://focus-student.netlify.app"));
        configuration.setAllowedOriginPatterns(List.of("http://localhost:3000","https://focus-student.netlify.app"));
